...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col max-w-2xl mx-auto" style={{ height: 'calc(100svh - 56px - 64px)' }}>
      ...
      {/* Input */}
      <div className="px-4 pt-3 pb-2 bg-white border-t border-purple-100 flex-shrink-0">
